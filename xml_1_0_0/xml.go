...
// Package xml_1_0_0 defines the data structures for Worldographer data format version 1.0.0.
package xml_1_0_0

//import "encoding/xml"
//
//// UnmarshalXML parses Worldographer data for this version. The data must be UTF-8 encoded.
//func UnmarshalXML(data []byte) (*XML, error) {
//	srcXML := &XML{}
//	if err := xml.Unmarshal(data, &srcXML); err != nil {
//		return nil, err
//	}
//	return srcXML, nil
//}
//
//// XML defines the native Worldographer data format for this version.
//// Be aware that this structure is hand-crafted to allow the `encoding/xml` package to unmarshal the data.
//// Changes to it may break things.
//type XML struct {
