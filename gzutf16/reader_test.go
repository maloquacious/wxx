...
//		}
//
//		// Create ReadCloser from compressed data
//		compressedReader := io.NopCloser(bytes.NewReader(gzipBuffer.Bytes()))
...
//		}
//
//		// Create ReadCloser from compressed UTF-8 data
//		compressedReader := io.NopCloser(bytes.NewReader(gzipBuffer.Bytes()))
//		rc, err := NewReadCloser(compressedReader)
//		if err != nil {
...
//		defer rc.Close()
//
//		// Reading should fail because UTF-8 data lacks the required UTF-16 BOM
...
//		}
//
//		// Create ReadCloser from compressed UTF-16 LE data
//		compressedReader := io.NopCloser(bytes.NewReader(gzipBuffer.Bytes()))
//		rc, err := NewReadCloser(compressedReader)
//		if err != nil {
//			t.Fatalf("NewReadCloser() should not fail for gzip data: %v", err)
...
//		defer rc.Close()
//
//		// Reading should work because the BOM in UTF-16 LE data tells the decoder the byte order
//		// The unicode.UTF16 decoder with ExpectBOM automatically handles both BE and LE
//		actualData, err := io.ReadAll(rc)
//		if err != nil {
//			t.Fatalf("ReadAll() error = %v", err)
//		}
