...
//)
//
//// xml_1_0_0_to_Map converts the XML from a version 1.0.0 file to the current Map.
//func xml_1_0_0_to_Map(m *xml_1_0_0.XML) (*Map, error) {
//	var err error
//
//	w := &Map{}
...
//		w.MapLayer = append(w.MapLayer, MapLayer{Name: layer.Name, IsVisible: layer.IsVisible})
//	}
//
...
//		w.Tiles.TileRows = append(w.Tiles.TileRows, make([]*Tile, w.Tiles.TilesHigh))
//		for _, line := range strings.Split(tilerow.InnerText, "\n") {
//			if len(line) == 0 { // ignore blank lines
//				continue
//			}
//			isXEdge, isYEdge := x == 0, y == 0
//			t := &Tile{Row: x, Column: y}
...
//			var resources Resources_t
//			if resources.Animal, err = strconv.Atoi(values[4]); err != nil {
//				return w, fmt.Errorf("value: animals: %w", err)
//			} else if resources.Animal < 0 {
//				return w, fmt.Errorf("value: animals: %w", fmt.Errorf("invalid value"))
//			} else if resources.Animal > 100 {
//				return w, fmt.Errorf("value: animals: %w", fmt.Errorf("invalid value"))
//			}
...
//				}
//			} else {
//				if resources.Brick, err = strconv.Atoi(values[5]); err != nil {
//					return w, fmt.Errorf("value: brick: %q: %w", values, err)
//				} else if resources.Brick < 0 {
//					return w, fmt.Errorf("value: brick: %w", fmt.Errorf("invalid value"))
//				} else if resources.Brick > 100 {
//					return w, fmt.Errorf("value: brick: %w", fmt.Errorf("invalid value"))
//				}
//				if resources.Crops, err = strconv.Atoi(values[6]); err != nil {
//					return w, fmt.Errorf("value: crops: %w", err)
//				} else if resources.Crops < 0 {
//					return w, fmt.Errorf("value: crops: %w", fmt.Errorf("invalid value"))
//				} else if resources.Crops > 100 {
//					return w, fmt.Errorf("value: crops: %w", fmt.Errorf("invalid value"))
//				}
//				if resources.Gems, err = strconv.Atoi(values[7]); err != nil {
//					return w, fmt.Errorf("value: gems: %w", err)
//				} else if resources.Gems < 0 {
//					return w, fmt.Errorf("value: gems: %w", fmt.Errorf("invalid value"))
//				} else if resources.Gems > 100 {
//					return w, fmt.Errorf("value: gems: %w", fmt.Errorf("invalid value"))
//				}
//				if resources.Lumber, err = strconv.Atoi(values[8]); err != nil {
//					return w, fmt.Errorf("value: lumber: %w", err)
//				} else if resources.Lumber < 0 {
//					return w, fmt.Errorf("value: lumber: %w", fmt.Errorf("invalid value"))
//				} else if resources.Lumber > 100 {
//					return w, fmt.Errorf("value: lumber: %w", fmt.Errorf("invalid value"))
//				}
//				if resources.Metals, err = strconv.Atoi(values[9]); err != nil {
//					return w, fmt.Errorf("value: metals: %w", err)
//				} else if resources.Metals < 0 {
//					return w, fmt.Errorf("value: metals: %w", fmt.Errorf("invalid value"))
//				} else if resources.Metals > 100 {
//					return w, fmt.Errorf("value: metals: %w", fmt.Errorf("invalid value"))
//				}
//				if resources.Rock, err = strconv.Atoi(values[10]); err != nil {
//					return w, fmt.Errorf("value: rock: %w", err)
//				} else if resources.Rock < 0 {
//					return w, fmt.Errorf("value: rock: %w", fmt.Errorf("invalid value"))
//				} else if resources.Rock > 100 {
//					return w, fmt.Errorf("value: rock: %w", fmt.Errorf("invalid value"))
//				}
//			}
//			if resources.Animal != 0 || resources.Brick != 0 || resources.Crops != 0 || resources.Gems != 0 || resources.Lumber != 0 || resources.Metals != 0 || resources.Rock != 0 {
...
//		}
//		f.Label.Location = &LabelLocation{
