...
type Map struct {
	...
	Configuration struct {
		TerrainConfig []*TerrainConfig `json:"terrainConfig,omitempty"`
		FeatureConfig []*FeatureConfig `json:"featureConfig,omitempty"`
		TextureConfig []*TextureConfig `json:"textureConfig,omitempty"`
		TextConfig    struct {
			LabelStyles []*LabelStyle `json:"labelStyles,omitempty"`
			InnerText   string        `json:"innerText,omitempty"`
		} `json:"textConfig,omitempty"`
		ShapeConfig struct {
...
type Tile struct {
	...
	Terrain               int          `json:"terrain"` // lookup into TerrainMap
